    ...
    <div>
      <div className="Candidate-Details1-container">
        <div className="Candidate-Details1-container-content">
          ...
          <div>
            <h3>STAR Example for a Financial Controller Position</h3>
            <h4>
          ...
          <div>
            <h3>Situation:</h3>
            <h4>
              As a Financial Controller, I had one week left to complete the
              year-end financial closing for the company. At the same time, I
          ...
          <div>
            <h3>Task:</h3>
            <h4>
              My responsibility was to ensure I gathered all the necessary
          ...
          <div>
            <h3>Action:</h3>
            <h4>
              I created a clear timeline to collect all the data by Monday. The
              rest of the week was dedicated to calculations and report writing.
